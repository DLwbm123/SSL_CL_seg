...
BASE='231cd6e9d98137bb9ba6afc8aff4cd1a10912303'
PARENT_SOURCE='f174cf2a68212cf04ad19b18d8203a6455c94aee'
DOC=Path('experiments/lcrseg/docs/dpr_sign_replication_v0_1')
PREFIXES=('experiments/lcrseg/dpr_sign_replication_v0_1/','experiments/lcrseg/tests/dpr_sign_replication_v0_1/',str(DOC)+'/')

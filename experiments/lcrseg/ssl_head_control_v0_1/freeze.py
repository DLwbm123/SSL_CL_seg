...
BASE='405337e71d22aef011a041664fbc1b4b72b60408'
PREFIXES=('experiments/lcrseg/ssl_head_control_v0_1/','experiments/lcrseg/tests/ssl_head_control_v0_1/','experiments/lcrseg/docs/ssl_head_control_v0_1/')
DOC=Path(PREFIXES[2])
def verify():

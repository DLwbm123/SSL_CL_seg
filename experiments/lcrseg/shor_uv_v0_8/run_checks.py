...
def main():
    ...
    names = {"fit", "fit_ridge", "fit_dual_heads", "select_lambda", "fit_calibrators", "pav_fit",
    ...
    argv = ["-q", "-p", "no:cacheprovider", "experiments/lcrseg/tests/shor_uv_v0_8", "experiments/lcrseg/tests/care_hr_v0_7_1",
    ...
    report = {"source_commit": source, "pytest_exit_code": exit_code, **counts,
              ...
              "coverage_note": "All inherited 189 regressions plus SHOR-UV prediction features, weighted Ridge, patient nesting, scoped target packages, GT-free deployment, fallback, seals and full synthetic target-to-report production pipeline."}

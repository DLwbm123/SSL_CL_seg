...
def test_real_three_stages_null_pas_and_registered_pair(monkeypatch):
    ...
    p, freeze, meta = b.verify(ROOT, code); source = ROOT/'docs/di_dmpa_jascl/gate1a_v2_results/gate1a_v2_8ae5d7532f90aee5d53c0d966706ef64c18a19ac_attempt1/feature_units/B0-EMA_seed2_stage0_val.json'
    ...
    assert len(audits) == 5 and all(x['bitwise_unchanged'] and x['extraction_completed'] for x in audits)

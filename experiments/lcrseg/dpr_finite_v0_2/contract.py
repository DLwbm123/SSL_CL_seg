...
BASE='69fba7c9d28dd4fb572b220d6ec5a6ffdb7089b9'
PARENT_SOURCE='f174cf2a68212cf04ad19b18d8203a6455c94aee'
DOC=Path('experiments/lcrseg/docs/dpr_finite_v0_2')
PREFIXES=('experiments/lcrseg/dpr_finite_v0_2/','experiments/lcrseg/tests/dpr_finite_v0_2/',str(DOC)+'/')
...
def admit(base,tid,source):
    ...
    if r['source']!=source or r['tasks']!=protocol()['tasks'] or r['formal_updates']!=31800:raise PermissionError('reservation identity')

...
| [Official ViT-S/14 weight](https://dl.fbaipublicfiles.com/dinov2/dinov2_vits14/dinov2_vits14_pretrain.pth) | SHA256 `b938bf1bc15cd2ec0feacfe3a1bb553fe8ea9ca46a7e1d8d00217f29aef60cd9`, 88,283,115 bytes | Single file acquired under the new study's remote-home `assets/`. Strict offline weight load passed; no `torch.hub` download. The weight is private to target storage and is not committed. |
